...
document.addEventListener("DOMContentLoaded", function () {
  ...
  ScrollReveal().reveal('.home_componentes', {
      origin: 'right',
      duration: 2000,
      distance: '20%'
  });

  ScrollReveal().reveal('.home_InterfaceDeConexao', {
      origin: 'left',
      duration: 1000,
      distance: '20%'
  });

  ScrollReveal().reveal('.hitory', {
      origin: 'right', // Corrigido de 'rigth'
      duration: 2000,
      distance: '20%'
  });
  ScrollReveal().reveal('.home_tipoDEPlacas', {
    origin: 'left',
    duration: 2000,
    distance: '20%'
});

ScrollReveal().reveal('.home_MaioresFabricantes', {
    origin: 'right',
    duration: 2000,
    distance: '20%'
});

ScrollReveal().reveal('.home_tecnologias', {
    origin: 'left',
    duration: 1000,
    distance: '20%'
});

ScrollReveal().reveal('.home_preco', {
    origin: 'right', // Corrigido de 'rigth'
    duration: 2000,
    distance: '20%'
});
ScrollReveal().reveal('.slots_Home', {
  origin: 'left',
  duration: 2000,
  distance: '20%'
});

ScrollReveal().reveal('.Home_Comoescolher', {
  origin: 'right',
  duration: 2000,
  distance: '20%'
});
ScrollReveal().reveal('.home_placas_jogos', {
  origin: 'left',
  duration: 2000,
  distance: '20%'
});
ScrollReveal().reveal('.home_quiz', {
  origin: 'right',
  duration: 2000,
  distance: '20%'
});
